...
cISI<-as_data_frame(df_ISI[,c('X.Subject.ID','strain_1','strain_2','strain_3','lps_B'
                              ,'lps_W1','lps_W2','lps_W3','lps_W4','lps_W5','lps_W6')])
...
write.csv(Table1, "Table1lts.csv")
...
Table2
write.csv(Table2, "Table2lts.csv")
