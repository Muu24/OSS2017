...
df_ISI[,'B_Latency']<-as.numeric(df_ISI[,'B_Latency'])
df_ISI[,'W1_Latency']<-as.numeric(df_ISI[,'W1_Latency'])
df_ISI[,'W2_Latency']<-as.numeric(df_ISI[,'W2_Latency'])
df_ISI[,'W3_Latency']<-as.numeric(df_ISI[,'W3_Latency'])
df_ISI[,'W4_Latency']<-as.numeric(df_ISI[,'W4_Latency'])
df_ISI[,'W5_Latency']<-as.numeric(df_ISI[,'W5_Latency'])
df_ISI[,'W6_Latency']<-as.numeric(df_ISI[,'W6_Latency'])
cISI<-as.data.frame(df_ISI[,c('Subject.ID','Strain_1','Strain_2','Strain_3','B_Latency'
                              ,'W1_Latency','W2_Latency','W3_Latency','W4_Latency','W5_Latency','W6_Latency')])
...
write.csv(Table1, "Table1sdl.csv")
...
Table2
write.csv(Table2, "Table2sdl.csv")
