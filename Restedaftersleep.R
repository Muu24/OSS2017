...
df_ISI[,'B_Rested']<-as.numeric(df_ISI[,'B_Rested'])
df_ISI[,'W1_Rested']<-as.numeric(df_ISI[,'W1_Rested'])
df_ISI[,'W2_Rested']<-as.numeric(df_ISI[,'W2_Rested'])
df_ISI[,'W3_Rested']<-as.numeric(df_ISI[,'W3_Rested'])
df_ISI[,'W4_Rested']<-as.numeric(df_ISI[,'W4_Rested'])
df_ISI[,'W5_Rested']<-as.numeric(df_ISI[,'W5_Rested'])
df_ISI[,'W6_Rested']<-as.numeric(df_ISI[,'W6_Rested'])
cISI<-as_data_frame(df_ISI[,c('Subject.ID','Strain_1','Strain_2','Strain_3','B_Rested'
                              ,'W1_Rested','W2_Rested','W3_Rested','W4_Rested','W5_Rested','W6_Rested')])
...
write.csv(Table1, "Table1ras.csv")
...
Table2
write.csv(Table2, "Table2ras.csv")
